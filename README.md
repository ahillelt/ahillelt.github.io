...
<head>
  ...
  <title>Alon Hillel‑Tuch — Computer Science · Cybersecurity · Engineering</title>
  ...
  <style>
    :root {
      --bg: #0b0f1a; /* near-slate */
      --panel: #0f172a; /* slate-900 */
      --ink: #e2e8f0; /* slate-200 */
      --muted: #a8b3cf; /* slate-400 */
    ...
    * { box-sizing: border-box; }
    ...
    body {
      margin: 0; background: radial-gradient(1200px 800px at 20% -10%, rgba(34,211,238,.08), transparent 60%),
                              radial-gradient(1000px 600px at 120% 10%, rgba(56,189,248,.07), transparent 60%),
                              var(--bg);
      color: var(--ink);
    ...
    header.nav { position: sticky; top: 0; backdrop-filter: saturate(150%) blur(8px); background: rgba(11,15,26,.6); border-bottom: 1px solid rgba(148,163,184,.12); z-index: 40; }
    .nav-inner { display: flex; align-items: center; justify-content: space-between; gap: 16px; }
    .brand { display:flex; align-items:center; gap:12px; font-weight:700; letter-spacing:.2px; }
    .brand .logo { width: 36px; height: 36px; border-radius: 10px; background: linear-gradient(135deg, var(--accent), var(--accent-2)); box-shadow: var(--shadow); display:grid; place-items:center; font-family:"JetBrains Mono", monospace; color:#001018; font-weight:800; }
    nav a { margin-left: 18px; font-weight: 500; color: var(--muted); }
    nav a:hover { color: var(--ink); }

    .hero { display:grid; grid-template-columns: 1.2fr .8fr; gap: 32px; padding: 56px 0 36px; align-items: center; }
    .hero-card { background: linear-gradient(180deg, rgba(255,255,255,.03), rgba(255,255,255,.01)); border: 1px solid rgba(148,163,184,.15); border-radius: var(--radius-xl); padding: 28px; box-shadow: var(--shadow); }
    .eyebrow { font-size: 13px; text-transform: uppercase; letter-spacing: .16em; color: var(--accent-2); font-weight: 700; }
    h1 { font-size: clamp(32px, 6vw, 56px); line-height: 1.15; margin: 8px 0 12px; }
    .tagline { font-size: clamp(16px, 2vw, 20px); color: var(--muted); }
    .chips { display:flex; flex-wrap:wrap; gap:10px; margin: 16px 0 22px; }
    .chip { background: var(--chip); color:#cbd5e1; border:1px solid rgba(148,163,184,.16); padding: 8px 12px; border-radius: 999px; font-size: 13px; }
    .cta { display:flex; gap:12px; margin-top: 8px; }
    .btn { display:inline-flex; align-items:center; gap:10px; border-radius: 12px; padding: 10px 14px; font-weight: 600; border:1px solid rgba(148,163,184,.18); background:#0b1220; color: var(--ink); }
    .btn.primary { background: linear-gradient(135deg, rgba(56,189,248,.18), rgba(34,211,238,.2)); border-color: rgba(56,189,248,.35); }

    .portrait { border-radius: 18px; overflow:hidden; border:1px solid rgba(148,163,184,.18); box-shadow: var(--shadow); background:#0c1324; aspect-ratio: 4 / 5; display:grid; place-items:center; color:#93c5fd; font-weight:700; }

    section { padding: 28px 0; }
    .section-title { font-size: 22px; font-weight: 800; letter-spacing:.2px; margin-bottom: 16px; }
    ...
    footer { border-top: 1px solid rgba(148,163,184,.16); color: var(--muted); padding: 24px 0 40px; }
  ...
  <main class="container">
    <section class="hero">
      <div class="hero-card">
        ...
        <h1>Building resilient socio‑technical systems with students and industry.</h1>
